...
def test_smartphone_initialization():
    phone = Smartphone(
        "iPhone 13", "Смартфон от Apple", 999.99, 10, 9.5, "A2634", "128 ГБ", "черный"
    )
...
def test_lawn_grass_initialization():
    grass = LawnGrass(
        "Газонная трава", "Смесь для газона", 25.0, 50, "Россия", "7-14 дней", "зеленый"
    )
...
def test_smartphone_str():
    ...
    assert str(phone) == (
        "iPhone 13, 999.99 руб. Остаток: 10 шт., "
...
def test_smartphone_add():
    ...
    phone2 = Smartphone(
        "iPhone 12", "Смартфон от Apple", 799.99, 5, 8.5, "A2403", "64 ГБ", "белый"
    )
...
def test_lawn_grass_add():
    ...
    grass2 = LawnGrass(
        "Газонная трава", "Смесь для газона", 30.0, 30, "США", "10-15 дней", "синий"
    )
